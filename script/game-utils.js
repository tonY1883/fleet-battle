...
function getShipTileImagesURL(shipsSet, classActing, status) {
	if (img_url.ship_tiles_nation[shipsSet] !== undefined && img_url.ship_tiles_nation[shipsSet].length > 0 && img_url.ship_tiles_nation[shipsSet][classActing].length > 0 && img_url.ship_tiles_nation[shipsSet][classActing][status].length > 0) {
